...
import com.yuweix.tripod.dao.mybatis.provider.SelectSqlProvider;
...
public interface SelectMapper<T extends Serializable, PK extends Serializable> {
	...
	T selectOneByIdSharding(@Param("shardingVal") Object shardingVal, @Param("id") PK id, @Param("clz") Class<T> clz);
