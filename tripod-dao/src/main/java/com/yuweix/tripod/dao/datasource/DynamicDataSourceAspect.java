...
public class DynamicDataSourceAspect extends DataSourceAspect {
     ...
     */
    @Pointcut("(!execution(* com.yuweix.tripod.sharding.Shardable+.*(..))) && (@within(com.yuweix.tripod.dao.datasource.DataSource) || @annotation(com.yuweix.tripod.dao.datasource.DataSource))")
    public void change() {
